...
-- FloatingButtons Table
CREATE TABLE IF NOT EXISTS FloatingButtons (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    button_image_url TEXT NOT NULL,
    target_tag TEXT NOT NULL, -- Corresponds to a product category/tag
    tooltip_text TEXT,        -- Optional tooltip for the button
    sort_order INTEGER DEFAULT 0, -- Optional: for ordering buttons if needed
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);